...
public class Hogar {
    ...
    public static void imprimirVivienda(Vivienda vivienda) {
    System.out.println("Precio: " + vivienda.precio);
    System.out.println("Número de habitaciones: " + vivienda.numHabitaciones);
    System.out.println("Superficie en m2: " + vivienda.superficie);
    System.out.println("¿Dispone de parking?: " + vivienda.parking);
    System.out.println("Estado: " + vivienda.estado);
    System.out.println("Propietario: " + vivienda.propietario);
}
